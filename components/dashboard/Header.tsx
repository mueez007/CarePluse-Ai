  ...
  return (
    <header className="glass border-b border-white/10 px-6 py-4">
      <div className="flex items-center justify-between">
        {/* Search Bar */}
        <div className="hidden md:flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 w-96">
          <Search className="w-5 h-5 text-gray-400" />
          <input
            type="text"
            placeholder="Search health insights, medications..."
            className="bg-transparent text-white placeholder:text-gray-500 outline-none flex-1"
          />
        </div>
            ...
            <AnimatePresence>
              {showNotifications && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  className="absolute right-0 top-12 w-80 glass rounded-xl border border-white/10 shadow-2xl z-50"
                >
            ...
            <AnimatePresence>
              {showUserMenu && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: -10 }}
                  className="absolute right-0 top-14 w-56 glass rounded-xl border border-white/10 shadow-2xl z-50"
                >
                  ...
                  <div className="p-2">
                    <button className="w-full flex items-center gap-3 p-3 rounded-lg hover:bg-white/5 transition text-gray-300">
