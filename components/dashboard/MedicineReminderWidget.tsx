  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-2 mb-4">
        ...
        <div className="text-center p-2 rounded-lg bg-white/5">
          <div className="text-xl font-bold text-white">{takenCount}</div>
          <div className="text-xs text-gray-500">Taken</div>
        </div>
        <div className="text-center p-2 rounded-lg bg-white/5">
          <div className="text-xl font-bold text-white">{localReminders.length}</div>
          ...
          >
            <div className="flex items-center gap-3 flex-1">
              ...
              <div className="flex-1">
                <p className="text-white font-medium text-sm">{reminder.name}</p>
      ...
      {/* Add Medicine Button */}
      <button className="w-full mt-4 py-2 rounded-xl border border-dashed border-white/20 text-gray-400 hover:text-white hover:border-white/40 transition text-sm flex items-center justify-center gap-2">
