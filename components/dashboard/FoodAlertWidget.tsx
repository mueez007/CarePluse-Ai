    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold text-white">Food Safety Alerts</h3>
        </div>
        ...
        {recentScans.map((scan, idx) => (
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-white text-sm font-medium">{scan.foodName}</p>
      ...
      {/* Quick Action */}
      <button className="w-full mt-4 py-2 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-500 text-white text-sm font-medium hover:shadow-lg transition">
        Scan Food Now
      </button>
    </motion.div>
  );
